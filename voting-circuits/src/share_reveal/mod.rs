...
pub use circuit::{
    ...
    ENC_SHARE_C2_Y_PUBLIC_OFFSET, K, PROPOSAL_ID_PUBLIC_OFFSET, SHARE_INDEX_PUBLIC_OFFSET,
    SHARE_NULLIFIER_PUBLIC_OFFSET, VOTE_COMM_TREE_ROOT_PUBLIC_OFFSET, VOTE_DECISION_PUBLIC_OFFSET,
