...
// protocol bases. Any accidental point collision is treated as a negligible hash-to-curve
...
/// x-coordinate and real nullifier the prover witnesses without
...
pub struct SyntheticPaddingNoteParts {
    ...
    pub cmx: [u8; 32],
    /// Real nullifier of the synthetic padding note (the one
